...
<div id="header">
	...
	<ul>
	<li><a href="../member/index.php" class="btn btn-primary">Home </a></li>
	<li><a href="../member/mahasiswa.php" class="btn btn-primary">Forum Pengaduan </a></li>
	<li><a href="../member/riwayat_pengaduan.php" class="btn btn-primary">Riwayat Pengaduan </a></li>
    <li><a href="../member/setting.php" class="btn btn-primary">Setting </a></li>
    <li><a href="../member/logout.php" class="btn btn-primary">Log Out </a></li>
	</ul>
