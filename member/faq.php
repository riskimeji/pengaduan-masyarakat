                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Frequently Asked Question (FAQ):</h6>
                        </div>
            <div class="main-content">
		        <p class="text-justify">
                    Q: Apakah Website Pengaduan Masyarakat Kota Padang ini?
                    <br />
		            A: Website Pengaduan Masyarakat Kota Padang ini berfungsi untuk menerima laporan pengaduan dari masayarakat Kota Padang.
                </p>
                <hr/>
        		<p class="text-justify">
                ...
                <hr/>
        		<p class="text-justify">
                    Q: Dari mana saya tahu pengaduan saya telah direspond?
                    <br />
        		    A: Kami akan mengirim anda email untuk membalas tentang laporan anda.
                </p>
                <hr/>
        		<p class="text-justify">
                    Q: Apakah Website Ini Sudah Sempurna?
                    <br />
        		    A: Website ini sedang dalam pengembangan.</a>
                </p>
            </div>
	</div>
